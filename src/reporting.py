...
def build_report(results: dict) -> str:
    ...
    lines.append(
        ...
        "2. متابعة نمط تجنّب `day_of_week=3` مع `pre_entry_pct_up_candles_15m` قرب المنتصف — الأقوى بين "
        "المرشحات رغم عدم اجتيازه FDR الصارم بعد.\n"
        "3. إعادة اختبار ميزات SHAP الأكثر ثباتًا (`sl_pct_of_atr`, momentum قصير المدى) كقواعد مباشرة "
        "ضمن نفس منهجية walk-forward + Monte Carlo، بدل تركها كمؤشر تفسيري فقط.\n"
